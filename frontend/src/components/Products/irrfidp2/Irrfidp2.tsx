...
import AOS from "aos";
import Featurecaurosel from "./Caurosel/Featurecaurosel_irp2.js";
...
import Collapsable from "./Collapsable/Collapsable_irp2.js";
      ...
      <IonGrid className="pgridrfid">
        <IonRow className="rowirp_player grbg">
          <IonCol size="12" className="hdl imgdl">
            <ReactPlayer
              url="https://res.cloudinary.com/dpysmqax5/video/upload/v1618743786/2Port_1.0001_nnjuja.mp4"
              width="100vw"
              height="95vh"
              playing={true}
              muted={true}
          ...
          <IonRow className="pd_rowir_des">
            <IonCol size="11" className="pd_txt_colir">
              <IonText className="pd_irtext bd_500">
                ScratchNest SN-IR 201 is a compact and fully integrated two port
                Long Range RAIN RFID Reader which works in the ultra-high
                frequency range. It boasts various features including a built-in
                9 dBi circular polarized antenna, an external antenna port of 50
                Ohm and USB, RS-232, RS-485, and LAN interfaces that make it
                easy to install and use. Additionally, the range of RF power is
                0 to 31.5 dBm which is adjustable via software. This reader is
                completely water resistant and specially designed to bear all
                weather conditions.
              </IonText>
            </IonCol>
          </IonRow>
          <IonRow className="features_irp_row">
            ...
            <IonCol size="5" className="col_irp_features">
              ...
              <IonRow className="feature_irp">
                <IonCol size="5" className="colfeature_irp">
                  <IonText className="feature_icon">
                    <EmojiTransportationIcon style={{ fontSize: "2.5rem" }} />
                  </IonText>
                  <IonText className="feature_count ga_2560">
        ...
        <IonRow className="ipr2_img1_product" data-aos="zoom-in-right">
          <IonCol size="12" className="imgcol_ipr_p"></IonCol>
        </IonRow>
        <IonRow className="ipr_img1_product" data-aos="zoom-in-left">
          <IonCol size="12" className="imgcol_ipr2_p2"></IonCol>
        </IonRow>
