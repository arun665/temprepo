                  ...
                  <IonCol size="10" className="col_pctxt">
                    <IonText className="pc_desc bld_600">
                      <IonCol size="7" className="inner_text_irp">
                        {" "}
                        <b> Dimension</b> - 200 x 160 x 30 mm
                        <br /> <b>Material</b> - Aluminium alloy
                ...
                <div className="pc_irpc_text">
                  <IonCol size="10" className="col_pctxt">
                    <IonText className="pc_desc bld_600">
                      <IonCol size="7" className="inner_text_irp">
                        {" "}
                        <b>Operating Temperature </b> <b>-</b> -25 to 65 °C
                  ...
                  <IonCol size="10" className="col_pctxt">
                    <IonText className="pc_desc bld_600">
                      <IonCol size="7" className="inner_text_irp">
                        ...
                        <br /> <b>Protocol </b> - ISO18000-62 {"&"} -63,
                        ISO29143
                        <br /> <b>Air Interface Protocol </b> - EPC Class1 Gen2
                        (ISO 18000-6C), ISO 18000-6A/B
                        <br /> <b>Antenna Port</b> - Four 50 Ohm external
                        antenna ports
                        <br />
                        ...
                        <br /> <b>RSSI data readout </b> - Supported
                ...
                <div className="pc_irpc_text">
                  <IonCol size="10" className="col_pctxt">
                    <IonText className="pc_desc bld_600">
                      <IonCol size="7" className="inner_text_irp">
                        {" "}
                        <b> USB </b> <b>-</b>USB type B
                        <br /> <b>LAN </b> - RJ45
                        <br /> <b>RS232 </b> - DB9 connector
                        <br /> <b>RS485 </b> - DB9 connector
                        <br /> <b>GPIO </b>
                        <br /> <b>Antenna </b> - TNC connector
                        <br />
                        <br />
                      </IonCol>
                    </IonText>
                  ...
                  <IonCol size="10" className="col_pctxt">
                    <IonText className="pc_desc bld_600">
                      <IonCol size="7" className="inner_text_irp">
                        ...
                        <br /> <b>Antenna 1 </b> - Yellow LED
                        <br /> <b>Antenna 2 </b> - Yellow LED
                        <br /> <b>Antenna 3 </b> - Yellow LED
                        <br /> <b>Antenna 4 </b> - Yellow LED
