...
import AOS from "aos";
import Featurecaurosel from "./Caurosel/Featurecaurosel_frp4.js";
...
import Collapsable from "./Collapsable/Collapsable_frp4.js";
      ...
      <IonGrid className="pgridrfid">
        <IonRow className="rowirp_player ">
          <IonCol size="12" className="hdl imgdl">
            <ReactPlayer
              url="https://res.cloudinary.com/dpysmqax5/video/upload/v1618744239/fixedreader_4port.mp4"
              width="100vw"
              height="95vh"
              playing={true}
              muted={true}
          ...
          <IonRow className="pd_rowir_des">
            <IonCol size="11" className="pd_txt_colir">
              <IonText className="pd_irtext bd_500">
                ScratchNest SN-FR 401 is a fixed four port RAIN RFID Reader
                which works in the ultra-high frequency range. It boasts various
                features including two antenna ports and USB, RS-232, RS-485,
                and LAN interfaces that make it easy to install and use.
                Additionally, the range of RF power is 0 to 31.5 dBm which is
        ...
        <IonRow className="fpr4_img1_product" data-aos="zoom-in-right">
          <IonCol size="12" className="imgcol_ipr_p"></IonCol>
        </IonRow>
        <IonRow className="fpr4_img_product" data-aos="zoom-in-left">
