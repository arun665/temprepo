...
import AOS from "aos";
import Featurecaurosel from "./Caurosel/Featurecaurosel";
...
import Collapsable from "./Collapsable/Collapsable.js";
  ...
  return (
    <div className="pirrfid">
      <IonGrid className="pgridrfid">
        <IonRow className="rowirp_player fcolorr">
          <IonCol size="12" className="hdl imgdl">
            <ReactPlayer
              url="https://res.cloudinary.com/dpysmqax5/video/upload/v1618743793/1Port_1.0001_jnnnl8.mp4"
              width="100vw"
              height="95vh"
              playing={true}
              muted={true}
          ...
          <IonRow className="pd_rowir_des">
            <IonCol size="11" className="pd_txt_colir">
              <IonText className="pd_irtext bd_500">
                ScratchNest SN-IR 101 is a compact and fully integrated Long
                Range RAIN RFID Reader that works in the ultra-high frequency
                range. It boasts various features including a built-in 9 dBi
                circular polarized antenna and USB, RS-232, RS-485, and LAN
                interfaces that make it easy to install and use. To add on, the
                range of RF power is 0 to 30 dBm which is adjustable via
                software. This reader is completely water resistant and
                specially designed to bear all weather conditions.
              </IonText>
            </IonCol>
          </IonRow>
        ...
        <IonRow className="ipr_img1_product" data-aos="zoom-in-left">
          <IonCol size="12" className="imgcol_ipr_p2"></IonCol>
        </IonRow>
