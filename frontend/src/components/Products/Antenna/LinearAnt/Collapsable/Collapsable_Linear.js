  ...
  render() {
    return (
      <div className="collapsable_irp">
        <IonRow
          className="btn_row_c tocursor irpc_rows"
        ...
        {/* <IonRow className="btn_row_c tocursor irpc_rows">
          <IonCol
            size="10"
            className="togglecol_clk "
            className={cx("app__toggle", " btn_collap", {
          ...
          <Collapse
            ...
            elementType="article"
            render={(collapseState) => <React.Fragment></React.Fragment>}
          />
          <div className="app__content">
            <IonRow className="btn-down">
              <IonCol size="3" className="filename_btn">
                <IonText className="textfile bdn_600">Linear Antenna</IonText>
              </IonCol>
